...
<!--                                <span class="right badge badge-danger">New</span>-->
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url()."lecturer/tqf3";?>" class="nav-link">
                            <i class="nav-icon fa fa-calendar"></i>
                            <p>
                                TQF.3
                                <!-- <span class="badge badge-info right">2</span>-->
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url()."lecturer/tqf4";?>" class="nav-link">
                            <i class="nav-icon fa fa-calendar"></i>
                            <p>
                                TQF.4
                                <!-- <span class="badge badge-info right">2</span>-->
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url()."lecturer/tqf5";?>" class="nav-link">
                            <i class="nav-icon fa fa-calendar"></i>
                            <p>
                                TQF.5
                                <!-- <span class="badge badge-info right">2</span>-->
